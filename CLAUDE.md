...
- `.github/workflows/release.yml` is **autogenerated by cargo-dist** — do not edit manually; run `cargo dist init --yes` to regenerate
- `dist-workspace.toml` controls the cargo-dist version and config; update it and regenerate to fix Release CI failures
