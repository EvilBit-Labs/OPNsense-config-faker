...
- **Ethical Development**: Respect original nett-media/opnsense-config-generator project
...
**CRITICAL**: The `opnsense/models/` directory contains Python code generated from the OPNsense XSD schema using xsdata-pydantic. This is part of the legacy Python implementation and should **NEVER** be modified for the Rust version.
